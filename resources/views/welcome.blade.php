    ...
    <div class="container py-1 ">
        <div class="row m-4 mt-n8 boxAccueil bg-white">
            ...
            <div class="col-lg-6 col-md-6 mb-2 px-lg-5">
                <p class="text-dark text-justify textes"> JOKKOLANTE est une agence qui intervient dans le domaine de la consultance, du digital, de l'ingénierie logicielle et de la formation certifiante en informatique.
                    <br> Notre mission est de d’accompagner à la transformation digitale des PME PMI Sénégalaise et étrangère, tout en prodiguant un service de qualité. Nous mettons nos clients au cœur du digital.
                </p>
            ...
            <div class="col-lg-6 col-md-6 mb-2 px-lg-5">
                <div class="bg-white d-flex align-items-center justify-content-between">
                    <img class="" src="{{asset('assets/images/bg1.png')}}" width="300px;" height="500px;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="row modif col-md-12" style="background-image: url(assets/images/Group352.jpg); background-size: contain;background-position:center;background-repeat: no-repeat;">
...
<div class="container-fluid py-5">
    <div class="row ">
        <div class="col-lg-4 col-md-6 mb-2 pt-3 px-lg-5 text-left ">
            <h3 class="text-dark texte1">Trouvez un freelance</h3>
            <p class="text-dark text-justify">Sur JoKKolante.com, postez votre annonce gratuitement et recevez les devis de nombreux travailleurs indépendants. </p>
            <a href="#" class="btn" style="background: #EB1566;margin-left:50px; border: 1px;border-radius: 20px; align-items: center;font-family:ubuntu;font-size:18px;line-height:30px;
        width: 200px; color: #fff; font-size: 1rem;">Recevoir des devis</a>
            <h3 class="text-dark mt-3  texte1">Vous êtes freelance ?</h3>
            <p class="text-dark text-justify">Inscrivez-vous gratuitement sur JoKKolante.sn pour trouver de nouvelles opportunités de vente de services. </p>
            <a href="#" class="btn" style="background: #009EE2;margin-left:50px; border: 1px;border-radius: 20px; align-items: center;
          width: 200px; color: #fff; font-size: 1rem;">S’inscrire</a>
            <h3 class="text-dark mt-3  texte1">Vous êtes freelance ? </h3>
            <p class="text-dark text-justify">Calculez votre salaire en portage salarial
                Profitez de la liberté du freelance et bénéficiez des avantages du salarié grâce au portage salarial.</p>
            <a href="#" class="btn" style="background: #EB1566;margin-left:50px; border: 1px;border-radius: 20px; align-items: center;
        width: 200px; color: #fff; font-size: 1rem;">Calculer mon salaire</a>
        </div>
        <div class="col-lg-8 col-md-6 mb-2 pt-3 px-lg-7 text-left">
            ...
            <div class="boxAccueil1 p-3 text-center">
                ...
                <img src="{{ asset('assets/images/gr.png') }}" alt="">
                </div>
                <div class="contenu">
                    <h5 class="text-dark">Recherche Equipe Freelancer divers domaines à long-terme</h5>
                    <p class="text-dark"> Ouvert • 500.000f CFA à 1.000.0000f CFA • 35 offres • Client #438918</p>
                    <p> Bonjour, Je souhaite constituer une équipe pour pouvoir répondre aux besoins de mes clients.<br>
            ...
            <div class="boxAccueil1  text-center" style="border: 1px dashed #009EE2;">
                ...
                <p class="text-dark" style="font-size: 1rem;">Vous recevrez une quinzaine de devis en quelques minutes
          ...
          width: 200px; color: #fff; font-size: 1rem;">S’inscrire</a>
            ...
            <div class="boxAccueil1 p-3 text-center">
                ...
                <a href="" style="text-decoration: none;color:black;font-family:ubuntu;font-size:20px;margin-top:10px;">Page suivante →</a>
        </div>
    </div>
</div>
...
<div class="container py-5 ">
    <div class=" container py-5 texte">
        ...
        <p class=" text-dark text-center ">JoKKolante.com a des freelances dans<br> chaque domaine du web. Consultez la<br> liste ci-dessous pour trouver les<br> freelances qui répondent à vos<br> besoins.</p>
    </div>
    <div class="row py-5" style="justify-content: end;">
        <div class="col-lg-4 col-md-8 mb-2">
            <div class="rent-item mb-4">
                <div class=" bg-white boxAccueil2 mb-3 p-4">
...
<div class="container-fluid py-5 text-center texte ">
    ...
    <p class=" text-center text-dark">Nos formations certifiantes à avec notre partenaire <span>DJOLOOF DIGITAL ACADEMY</span>
    ...
    <a href="apropos" class="btn1 btn-bouton p-3">Recevoir des devis</a>
                        ...
                        <div class="carousel-item active">
                            <div class="cards-wrapper">
                                <div class="box2 text-center">
                                    <img src="assets/images/logo-free.jpg" alt="" style="box-shadow: 0 1px 0 0 #EB1566; border: 1px solid #EB1566;">
                                </div>

                                <div class="box2 text-center">
                                    <img src="assets/images/logo-expresso.png" alt="" style="box-shadow: 0 1px 0 0 #22427C; border: 1px solid #22427C;">
                                </div>

                                <div class="box2 text-center ">
                                    <img src="assets/images/logo-pro.jpg" alt="" style="box-shadow: 0 1px 0 0 #EB1566; border: 1px solid #EB1566;">
                                </div>

                                <div class="box2 text-center ">
                                    <img src="assets/images/logo-atos.jpg" alt="" style="box-shadow: 0 1px 0 0 #007FFF; border: 1px solid #007FFF;">
                                </div>
                            </div>
