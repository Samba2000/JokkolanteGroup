                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    LinkedIn m'incite à te parler un peu de comment je suis, ce que je fais et comment
                                    je
                                    <br>
                                    vois l'avenir. <br>
                                    📌Motivée et ambitieuse, je suis une passionnée du digital, de l'informatique en
                                    <br>
                                    particulier, par tout ce qui est innovation et création💡🚀. <br>
                                    📌Je suis développeuse d'application web et logiciel et diplomée de l'Institut
                                    National
                                    <br>
                                    des Technologies de l'Information (NIIT) en licence professionnelle Génie Logiciel.
                                    <br>
                                    📌Grâce à ma formation en génie logiciel, j’ai développé de sérieuses connaissances
                                    en
                                    <br>
                                    programmation d'applications, de la modélisation avec UML (Langage de Modélisation
                                    <br>
                                    Unifié) 📈 et l'utilisation de différentes logiciels de codage et en matière de <br>
                                    graphisme ou de mise en page🧑‍💻; qui alliées à mes qualités de jeune
                                    informaticienne,
                                    <br>
                                    de ma créativité et de ma détermination m’ont conforté dans ma volonté d’intégrer
                                    une
                                    <br>
