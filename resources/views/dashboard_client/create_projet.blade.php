...
<body>
    ...
    <div class="container-fluid create-projet">
                ...
                <form action="">
                    <div class="col-md-12 mb-3">
                        <div class="col-md-4" >
                            ...
                            <input type="nom" class="form-control" id="exampleFormControlInput1">
                        </div>
                        <div class="col-md-4" >
                            <label for="exampleFormControlInput1" class="form-label">Prénom</label>
                            <input type="prenom" class="form-control" id="exampleFormControlInput1">
                        </div>
                        <div class="col-md-4" >
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="col-md-6" >
                            ...
                            <input type="titre" class="form-control" id="exampleFormControlInput1">
                        </div>
                        <div class="col-md-6" >
                            <label for="exampleFormControlInput1" class="form-label">Acronyme projet</label>
                            <input type="acronyme" class="form-control" id="exampleFormControlInput1">
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="col-md-6" >
                            <label for="exampleFormControlInput1" class="form-label">Date de debut</label>
                            <input type="date_debut" class="form-control" id="exampleFormControlInput1">
                        </div>
                        <div class="col-md-6" >
                            <label for="exampleFormControlInput1" class="form-label">Date de fin</label>
                            <input type="date_fin" class="form-control" id="exampleFormControlInput1">
                        </div>
                    </div>
