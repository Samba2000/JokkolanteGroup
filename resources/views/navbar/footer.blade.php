 ...
 <div class="container-fluid bg-dark ">
        ...
        <div class="col-lg-3">
          <ul class="list-unstyled mb-0" style="text-align: left">
            ...
            <li>
              <a href="#!" class="text-white">Freelances par ville</a>
            </li>
            <li>
              <a href="#!" class="text-white">Projets par catégorie</a>
            </li>
            <li>
              <a href="#!" class="text-white">Les avis Jokkolante.sn</a>
            </li>
            <li>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="row ">
                    <div class="col-lg-12 col-md-6 mb-2 ">
                          <a class="btn  btn-floating m-1" href="#!" role="button"><img src="{{ asset('assets/images/fac.png') }}" alt=""></a>

        <!-- Twitter -->
        <a class="btn btn-floating m-1" href="#!" role="button"><img src="{{ asset('assets/images/twitter.png') }}" alt=""> </a>
        ...
        <a class="btn  btn-floating m-1" href="#!" role="button"><img src="{{ asset('assets/images/linki.png') }}" alt=""></a>
            ...
            <div class="row d-flex justify-content-center">
              ...
              <div class="col-md-12">
                ...
                <div class="form-outline mb-4">
                  <input type="email" id="form5Example2" class="form-control" placeholder="Entrez votre mail" aria-label="Entrez votre mail"/>
          ...
          <img src="{{ asset('assets/images/ls.png') }}" style="margin-left: 5%;" alt="">
          </div>
            </div>
        </div>
    </div>
