...
<body>
    ...
    <div class="row modif col-md-12"
        style="background-image: url(assets/images/Group352.jpg); background-size: contain;background-position:center;background-repeat: no-repeat;">
        ...
        <div class="container-fluid py-5">
            <div class="row ">
                <div class="col-lg-4 col-md-6 mb-2 pt-3 px-lg-5 text-left ">
                    ...
                    <a href="#" class="btn"
                        style="background: #EB1566;margin-left:50px; border: 1px;border-radius: 20px; align-items: center;font-family:ubuntu;font-size:18px;line-height:30px;
        width: 200px; color: #fff; font-size: 1rem;">Recevoir
                        des devis</a>
                    ...
                    <a href="#" class="btn"
                        style="background: #009EE2;margin-left:50px; border: 1px;border-radius: 20px; align-items: center;
          width: 200px; color: #fff; font-size: 1rem;">S’inscrire</a>
                    ...
                    <p class="text-dark text-justify">Calculez votre salaire en portage salarial
                        ...
                        salarial.</p>
                    <a href="#" class="btn"
                        style="background: #EB1566;margin-left:50px; border: 1px;border-radius: 20px; align-items: center;
        width: 200px; color: #fff; font-size: 1rem;">Calculer
                        mon salaire</a>
                </div>
                <div class="col-lg-8 col-md-6 mb-2 pt-3 px-lg-7 text-left">
                    ...
                    <div class="boxAccueil1  text-center" style="border: 1px dashed #009EE2;">
                        ...
                        <p class="text-dark" style="font-size: 1rem;">Vous recevrez une quinzaine de devis en quelques
                            minutes
          ...
          width: 200px; color: #fff; font-size: 1rem;">S’inscrire</a>
                    ...
                    <a href=""
                        style="text-decoration: none;color:black;font-family:ubuntu;font-size:20px;margin-top:10px;">Page
                        suivante →</a>
                </div>
            </div>
        </div>
