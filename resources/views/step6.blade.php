...
<div class="progress">
  ...
  <h2 class="w-100 titré">Préférence de contact</h2>
   <div class="col-md-12 col-sm-5 vos">
   <div class="col-md-5 new">
          <h5>La messagerie privée de jokkalante.sn</h5>
       ...
       <img src="assets/images/g4.png" alt="">
        ...
        <div class="col-md-5 new">
        <h5 class="" >Adresse email <span style="color:#ccc;"> (qui sera affichée aux prestataires)
</span></h5>
            <div class="form-check form-switch">
       ...
       <img src="assets/images/g3.png" alt="">
        ...
        <div class="col-md-5 new">
          <h5>Numero de téléphone <span style="color:#ccc;">(qui sera affiché aux prestataires)</span></h5>
            <div class="form-check form-switch">
       ...
       <a id="but" href="step7" class="col-md-6 btn btn-primary"> Continuer </a>
        </div>
    </div>
